...
power_lunch = Recipe.create(recipe_name: "Spinach, Tomato and Squash Dip aka POWER LUNCH", user: andrew)
...
ri6 = RecipeIngredient.create(recipe: power_lunch, ingredient: tomato)
ri7 = RecipeIngredient.create(recipe: power_lunch, ingredient: squash)
ri8 = RecipeIngredient.create(recipe: power_lunch, ingredient: spinach)
